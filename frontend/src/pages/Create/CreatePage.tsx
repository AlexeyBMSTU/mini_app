        ...
        <CardContent className={styles.createCardContent}>
          <form onSubmit={handleSubmit}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              <Box className={styles.formSection} sx={{ display: 'flex', gap: 2, flexDirection: { xs: 'column', sm: 'row' } }}>
              ...
              <Box className={styles.formSection}>
                ...
                >
                  <Button
                    ...
                    startIcon={isSubmitting ? <CircularProgress size={20} color="inherit" className={styles.loadingSpinner} /> : undefined}
                  >
